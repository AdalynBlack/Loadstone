...
public static class ConflictResolver
{
	...
	public static void TryPatch(Type type)
	{
		try {
			...
			Loadstone.HarmonyLog.LogFatal($"Loadstone failed to patch {type}. The following exception was received:\n{exception.ToString()}");
		}
	}
}
